...
class AI(Player):
    ...
    def cutoff(self, state, depth):
        return  SeegaRules.is_end_game(state) or depth > 0   # TODO replace by your code
    ...
    def evaluate(self, state):
        return state.score[self.color.value]  # or state.captured(self.color.value)-state.captured(-self.color.value) ? 
